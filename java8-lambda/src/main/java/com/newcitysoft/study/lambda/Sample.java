...
public class Sample {
    ...
    private static List<Student> initList() {
        ...
        students.add(new Student.StudentBuilder().stuId("120402033").name("tianlixin").age(26)
                .bedroom("323").major("软件工程").gender(Gender.MALE).tel("15841694657").build());

        students.add(new Student.StudentBuilder().stuId("120402055").name("xiaohaun").age(25)
                .bedroom("623").major("软件工程").gender(Gender.FEMALE).tel("15841694612").build());

        students.add(new Student.StudentBuilder().stuId("120403045").name("yongxiaoxu").age(26)
